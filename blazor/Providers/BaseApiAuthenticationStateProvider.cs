...
{
    public class BaseApiAuthenticationStateProvider : AuthenticationStateProvider
    {
        private readonly ILocalStorageService _localStorage;

        public BaseApiAuthenticationStateProvider(ILocalStorageService localStorage)
        {
        ...
        {
            var annonymousUser = new ClaimsPrincipal();
